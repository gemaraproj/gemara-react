...
export default defineConfig({
  ...
  entry: {
    ...
    "capability-catalog/index": "src/capability-catalog/index.ts",
    "principle-catalog/index": "src/principle-catalog/index.ts",
    "threat-catalog/index": "src/threat-catalog/index.ts",
    "vector-catalog/index": "src/vector-catalog/index.ts",
